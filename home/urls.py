...
urlpatterns = [
    ...
    path('custom_admin/approve_donor/<int:donor_id>/', views.approve_donor, name='approve_donor'),
    ...
    path('custom_admin/block_donor/<int:donor_id>/', views.block_donor, name='block_donor'),
    path('custom_admin/unblock_donor/<int:donor_id>/', views.unblock_donor, name='unblock_donor'),
